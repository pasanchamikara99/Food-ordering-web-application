                ...
                if($result)
                {
                    ...
                    else
                    {
                        while($row = mysqli_fetch_array($result))
                        {
                            ...
                            $sql = "INSERT INTO cart(user_id,user_name,food_image,food_id,food_item,food_catagory,price) VALUES ('$userID','$username','$foodimage','$foodid','$foodname','$foodcatagory','$foodprice')";  
                            $result =  mysqli_query($conn,$sql);
